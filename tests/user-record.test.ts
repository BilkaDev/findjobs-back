  ...
  expect(
    () =>
      new UserRecord({
        ...defaultObj,
        email:
          '1234567890123456789012345678901aaaaaaaaaaaaaa1234567890123456789012345678901aaaaaaaaaaaaaa1234567890123456789012345678901aaaaaaaaaaaaaa1234567890123456789012345678901aaaaaaaaaaaaaa1234567890123456789012345678901aaaaaaaaaaaaaa',
      }),
  ).toThrow('Email cannot be blank or exceed 100 characters');
});
